...
input_directory <- "/home/agalvez/data/metabolic_amoeba/version4/data/general/annotations/curated/COG"
output_directory <- "/home/agalvez/data/metabolic_amoeba/version4/data/general/annotations/curated/processed"
...
files <- list.files(input_directory, pattern = "\\.fasta\\.emapper\\.annotations$", full.names = TRUE)
...
prefix <- "processed_COG_curated_annotated_"
suffix <- ".fasta.emapper"
...
write_tsv(
  ...
  "/home/agalvez/data/metabolic_amoeba/version4/results/tips_COG_percentage_freq_v4.tsv"
)
