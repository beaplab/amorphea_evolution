...
# Define the input and output directories (remove hashtags and extract_COG_from_eggnog_without_hashtags.pl beforehand)
input_directory <- "/home/agalvez/data/metabolic_amoeba/version4/data/metazoa_vs_fungi/curated/COG"
output_directory <- "/home/agalvez/data/metabolic_amoeba/version4/data/metazoa_vs_fungi/curated/processed"
...
files <- list.files(input_directory, pattern = "\\.fasta\\.transdecoder\\_clustered\\.pep\\.emapper\\.annotations$", full.names = TRUE)

#  this <- read_tsv(files[86])
# #
# this <- this |>
...
process_file <- function(file) {
  ...
  # counts_metabolic_potential <- table(metabolic_potential$COG_category)
  # percentage_metabolic_potential <- prop.table(counts_metabolic_potential) * 100
...
suffix <- ".fasta.transdecoder_clustered.pep.emapper"
...
write_tsv(
  ...
  "/home/agalvez/data/metabolic_amoeba/version4/results/metazoa_vs_fungi_tips_COG_percentage_freq.tsv"
)
